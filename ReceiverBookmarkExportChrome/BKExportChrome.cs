...
{
    public class BKExportChrome : ReceiverFileFromStorage<DateTime>
    {

        public BKExportChrome(string fileName):base(fileName,readAllFirstTime: true,fileEnconding:Encoding.UTF8)
        {
