rem xcopy Demo* StankinsD /I /F /R /E /Y 
xcopy Demo1JobFolders StankinsDemo\Demo1JobFolders  /I /F /R /E /Y 
xcopy Demo2SimpleJobView StankinsDemo\Demo2SimpleJobView  /I /F /R /E /Y 
