...
{
    public class ReceiverJenkinsJob : AliveStatus, IReceive
    {
        private readonly string url;
        private readonly string jobName;

        public ReceiverJenkinsJob(string url, string jobName) : this(new CtorDictionary()
        {
            {nameof(url),url },
        ...
        public ReceiverJenkinsJob(CtorDictionary dataNeeded) : base(dataNeeded)
        {
