...
{
    public class SenderDBDiagramToFile : BaseObject, ISenderToOutput
    {

        public string InputContents { get; set; }
        public KeyValuePair<string, string>[] OutputContents { get; set; }

        public SenderDBDiagramToFile(string inputContents) : this(new CtorDictionary() {
        ...
        public SenderDBDiagramToFile(CtorDictionary dataNeeded) : base(dataNeeded)
        {
