...
{
    public class TransformClearTables : BaseObject, ITransformer
    {

        public TransformClearTables(CtorDictionary dataNeeded) : base(dataNeeded)
        {
        }
        public override async Task<IDataToSent> TransformData(IDataToSent receiveData)
        {
            //TODO: demeter principle is not here
            receiveData.Metadata.Tables.Clear();
            receiveData.Metadata.Columns.Clear();
            receiveData.Metadata.Relations.Clear();
            receiveData.DataToBeSentFurther.Clear();
